        ...
        <div class="row  border-bottom white-bg page-heading">
            <div class="col-sm-4">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a class="active" href="javascript:void(0)">佣金审核</a>
                    </li>
                </ol>
            </div>
        </div>
            ...
            <div class="ibox-content m-b-sm border-bottom">
                <div class="row">
                    <div class="form-group col-md-4 m-t-xs m-b-none">
                        <input value="" placeholder="楼盘/经纪公司/门店名称，经纪人/置业顾问手机号" class="form-control input-sm">
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group ">
                                                ...
                                                <a href="${ctx }/view/agreement/view" class="btn btn-white btn-sm "><i class="fa fa-eye"></i>  查看</a>
                                            </div>
                                        </td>
                                    </tr>
