        ...
        <div class="row  border-bottom white-bg page-heading">
            <div class="col-sm-4">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                        <a class="active" href="javascript:void(0)">置业顾问实名认证</a>
                    </li>
                </ol>
            </div>
        </div>
                            ...
                            <div class="table-responsive ">
                                <table class="table table-centerbody table-mail table-striped table-condensed text-nowrap"
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group ">
                                                <a class="btn btn-white btn-sm through" data-id="1"><i class="fa fa-check-circle-o"></i>  通过</a>
                                                <a class="btn btn-white btn-sm refuse" data-id="1"><i class="fa fa-ban"></i>  拒绝</a>
                                            </div>
                                        </td>
                                    </tr>
