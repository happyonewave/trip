...
<div class="ibox-content">
            ...
            <c:if test="${page!=null && (page.list)!= null && fn:length(page.list) > 0 }">
                <c:forEach var="n" items="${page.list }">
                    <tr>
                        ...
                        <td>${n.productId}</td>
                        <td>${n.text}</td>
                        <td><fmt:formatDate value="${n.time}" pattern="yyyy-MM-dd"/></td>
                        <td>${n.grade}</td>
    ...
    <!-- 分页表单 -->
    <form action="${ctx }/comments/list_page" id="commentsPageForm">
        <!-- 查询条件，用隐藏表单域 -->
        ...
        <jsp:include page="/WEB-INF/views/common/page.jsp" flush="true">
            <jsp:param name="formId" value="commentsPageForm"/>
